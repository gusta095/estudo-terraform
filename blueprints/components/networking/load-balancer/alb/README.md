...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_alb"></a> [alb](#module\_alb) | terraform-aws-modules/alb/aws | 9.14.0 |
...
| <a name="input_alb_name"></a> [alb\_name](#input\_alb\_name) | Nome do Load Balancer | `string` | `null` | no |
...
| <a name="input_load_balancer_type"></a> [load\_balancer\_type](#input\_load\_balancer\_type) | Define o tipo de Load Balancer | `string` | `"application"` | no |
...
| <a name="input_subnets"></a> [subnets](#input\_subnets) | Lista de IDs de subnets a serem associadas ao Load Balancer | `list(string)` | `null` | no |
